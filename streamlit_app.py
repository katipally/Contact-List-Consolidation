"""
Easy-to-Use Web Interface for Contact Processing

This creates a simple web page where you can:
- Upload your messy contact files
- Click one button to clean and organize everything
- Download your perfectly organized contact list

No technical knowledge needed - just upload and click!
"""
