...
This is the "conductor" that runs all 5 processing steps in the right order.
It makes sure each step finishes successfully before starting the next one.

The processing steps:
1. Convert files (Excel → CSV)
2. Map column names (standardize headers) 
3. Consolidate data (combine multiple files)
4. Find duplicates (AI-powered smart merging)
5. Enrich emails (find missing contact info)

It handles errors gracefully and keeps track of progress so you know what's happening.
"""
